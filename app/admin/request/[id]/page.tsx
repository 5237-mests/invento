...
//           <button
//             onClick={() => router.push(`/admin/request/edit/${request?._id}`)}
//             className={`bg-blue-500 hover:bg-blue-700 text-white px-4 py-2 rounded ${request?.status === 'cancelled' ? 'hidden' : ''} ${request?.status === 'completed' ? 'hidden' : ''}`}
//           >
//             Edit
//           </button>
//           <button
//             onClick={cancelRequest}
//             className={`bg-red-500 hover:bg-red-700 text-white px-4 py-2 rounded ${request?.status === 'cancelled' ? 'hidden' : ''} ${request?.status === 'completed' ? 'hidden' : ''}`}
//           >
//             Cancel
//           </button>
//           <button
//             onClick={approveRequest}
//             className={`bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded ${request?.approved ? 'hidden' : ''} ${request?.status === 'cancelled' ? 'hidden' : ''} ${request?.status === 'completed' ? 'hidden' : ''}`}
//           >
//             Approve
//           </button>
//         </div>
