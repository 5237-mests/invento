...
//     if (filtered.length == items.length || filtered.length == 0 || filtered.length >= itemsPerPage) setSearched(false)
//   };
...
//       setFilteredItems(response.data.data); // initialize filteredItems
//     } catch (error) {
...
//   return (
//     <div className="p-3 min-h-screen text-slate-950">
//       <div className="m-5">
...
//               >
//                 <td className="py-1">{ searched ? index + 1 : items.indexOf(item) + 1}</td>
...
//   if (loading) {
//     return <div className="p-3 min-h-screen flex items-center justify-center text-slate-950">Loading...</div>;
//   }
